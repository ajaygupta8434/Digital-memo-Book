...
<head>
  ...
  <link rel="stylesheet" href="partials/logical.css">


  <title>digital memobook - Notes taking made easy</title>
        ...
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td> <button class='edit btn btn-sm btn-primary' id=".$row['sn'].">Edit</button>
             <button class='delete btn btn-sm btn-primary' id=d".$row['sn'].">Delete</button> 
              </td>
          </tr>";
        } 
          ?>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/loginsystem/welcome.php?delete=${sn}`;
